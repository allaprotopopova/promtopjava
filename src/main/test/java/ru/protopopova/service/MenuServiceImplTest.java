...
public class MenuServiceImplTest extends AbstractServiceTest {
    ...
    void getMenuByRestaurant() {
        assertMatch(service.getByRestaurant(1), List.of(MENU_1, MENU_2));
    }
    @Test
    ...
    @Test
    void getMenuByDate() {
        assertMatch(service.getByDate(LocalDate.of(2019,4,30)), List.of(MENU_1, MENU_3, MENU_4));
    }
    ...
    void delete() {
        service.delete(21);
        assertMatch(service.getByRestaurant(1), List.of(MENU_2));
    }

    @Test
    void save() {
        Menu newMenu = getCreated();
        Menu savedMenu = service.save(newMenu, 1);
