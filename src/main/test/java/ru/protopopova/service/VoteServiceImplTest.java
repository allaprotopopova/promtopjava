...
class VoteServiceImplTest extends AbstractServiceTest {
    ...
    void getVotesHistory() {
        Map<LocalDate, List<Vote>> votesHistory = service.getHistoryByRestaurant(1);
    ...
    @Test
    void getVotesByDate() {
        Map<Restaurant, List<Vote>> votesHistory = service.getByDate(LocalDate.of(2019, 04, 30));
    ...
    void getVotesByDateAndRestaurant() {
        List<Vote> votes = service.getByDateAndRestaurant(LocalDate.of(2019, 04,30), 1);
    ...
    void getVotesByDateAndRestaurantNotFound() {
        List<Vote> votes = service.getByDateAndRestaurant(LocalDate.of(2019, 03,30), 1);
