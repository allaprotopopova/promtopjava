...
public class MenuData {
    ...
    public static final Menu MENU_4 = new Menu(25,RESTAURANT_3 ,LocalDate.of(2019, 4, 30), List.of(DISH7, DISH8, DISH10, DISH12, DISH13, DISH17));
    ...
    public static void assertMatch(Menu actual, Menu expected) {
        ...
        Assert.isTrue(actual.getRestaurant().getId().equals(expected.getRestaurant().getId()), "");
    }
